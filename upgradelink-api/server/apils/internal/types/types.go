...
type DownloadData struct {
	...
	DownloadVersion []DownloadVersionData `json:"downloadVersion"`
	VersionList     []VersionInfoData     `json:"versionList"`
}
...
type DownloadVersionData struct {
	...
	DownloadGithubUrl string `json:"downloadGithubUrl,optional"`
}
