...
func (l *GetElectronUpgradeInfoLogic) GetElectronUpgradeInfo(req *types.GetElectronUpgradeInfoReq) (resp *types.GetElectronUpgradeInfoResp, err error) {
	...
	if err != nil {
		return nil, http_handlers.NewLinkErr(l.ctx, http_handlers.ErrParamInvalid, l.svcCtx.Trans.Trans(l.ctx, "common.versionFormatError"), l.svcCtx.Trans.Trans(l.ctx, "electron.paramErrorDocs"))
	}
	...
	if err != nil && errors.Is(err, model.ErrNotFound) {
		resp = &types.GetElectronUpgradeInfoResp{
			...
			PromptUpgradeContent: l.svcCtx.Trans.Trans(l.ctx, "common.alreadyLatestVersion"),
		}
		return resp, nil
	} else if err != nil {
		return nil, http_handlers.NewLinkErr(l.ctx, http_handlers.ErrInternalServerError, l.svcCtx.Trans.Trans(l.ctx, "common.databaseError"), l.svcCtx.Trans.Trans(l.ctx, "common.internalErrorDocs"))
	...
	if err != nil && errors.Is(err, model.ErrNotFound) {
		return nil, http_handlers.NewLinkErr(l.ctx, http_handlers.ErrInternalServerError, l.svcCtx.Trans.Trans(l.ctx, "electron.versionNotFound"), l.svcCtx.Trans.Trans(l.ctx, "electron.versionNotFoundDocs"))
	} else if err != nil {
		return nil, http_handlers.NewLinkErr(l.ctx, http_handlers.ErrInternalServerError, l.svcCtx.Trans.Trans(l.ctx, "common.databaseError"), l.svcCtx.Trans.Trans(l.ctx, "common.internalErrorDocs"))
	}
