...
func (x *CompanySecretInfo) GetDescription() string {
	if x != nil && x.Description != nil {
		return *x.Description
	}
	return ""
...
func (x *CompanySecretInfo) GetIsDel() uint32 {
...
func (x *CompanySecretListReq) GetEnable() uint32 {
	if x != nil && x.Enable != nil {
		return *x.Enable
	}
	return 0
...
func (x *CompanySecretListReq) GetDescription() string {
	if x != nil && x.Description != nil {
		return *x.Description
	}
	return ""
...
func (x *CompanySecretListReq) GetIsDel() uint32 {
	if x != nil && x.IsDel != nil {
		return *x.IsDel
	}
	return 0
...
const file_rpc_core_proto_rawDesc = "" +
	...
	"\n" +
	"company_id\x18\x04 \x01(\x04H\x03R\tcompanyId\x88\x01\x01\x12\"\n" +
	"\n" +
	...
	"\n" +
	"company_id\x18\x05 \x01(\x04H\x02R\tcompanyId\x88\x01\x01\x12\"\n" +
	"\n" +
	...
	"\f_descriptionB\t\n" +
	"\a_is_del\"Z\n" +
	"\x15CompanySecretListResp\x12\x14\n" +
	"\x05total\x18\x01 \x01(\x04R\x05total\x12+\n" +
	"\x04data\x18\x02 \x03(\v2\x17.core.CompanySecretInfoR\x04data\"\x98\x03\n" +
	...
	"\x06leader\x18\x04 \x01(\tH\x01R\x06leader\x88\x01\x01B\a\n" +
	"\x05_nameB\t\n" +
	"\a_leader\"T\n" +
	...
	"\x05total\x18\x01 \x01(\x04R\x05total\x12&\n" +
	"\x04data\x18\x02 \x03(\v2\x12.core.PositionInfoR\x04data\"\x81\x03\n" +
	"\bRoleInfo\x12\x13\n" +
	"\x02id\x18\x01 \x01(\x04H\x00R\x02id\x88\x01\x01\x12\"\n" +
	"\n" +
	"created_at\x18\x02 \x01(\x03H\x01R\tcreatedAt\x88\x01\x01\x12\"\n" +
	...
	"\bUUIDsReq\x12\x10\n" +
	"\x03ids\x18\x01 \x03(\tR\x03ids\"\xc5\x06\n" +
	"\bUserInfo\x12\x13\n" +
	"\x02id\x18\x01 \x01(\tH\x00R\x02id\x88\x01\x01\x12\"\n" +
	"\n" +
	"created_at\x18\x02 \x01(\x03H\x01R\tcreatedAt\x88\x01\x01\x12\"\n" +
	...
	"\n" +
	"company_id\x18\x13 \x01(\x04H\x0eR\tcompanyId\x88\x01\x01B\x05\n" +
	"\x03_idB\r\n" +
	"\v_created_atB\r\n" +
	"\v_updated_atB\t\n" +
	"\a_statusB\v\n" +
	...
	"\busername\x18\x01 \x01(\tR\busername2\xc5 \n" +
	"\x04Core\x12,\n" +
	...
	"\finitDatabase\x12\v.core.Empty\x1a\x0e.core.BaseResp\x124\n" +
	"\rcreateCompany\x12\x11.core.CompanyInfo\x1a\x10.core.BaseIDResp\x122\n" +
	"\rupdateCompany\x12\x11.core.CompanyInfo\x1a\x0e.core.BaseResp\x12=\n" +
	"\x0egetCompanyList\x12\x14.core.CompanyListReq\x1a\x15.core.CompanyListResp\x120\n" +
	"\x0egetCompanyById\x12\v.core.IDReq\x1a\x11.core.CompanyInfo\x12-\n" +
	"\rdeleteCompany\x12\f.core.IDsReq\x1a\x0e.core.BaseResp\x12@\n" +
	"\x13createCompanySecret\x12\x17.core.CompanySecretInfo\x1a\x10.core.BaseIDResp\x12>\n" +
	"\x13updateCompanySecret\x12\x17.core.CompanySecretInfo\x1a\x0e.core.BaseResp\x12O\n" +
	"\x14getCompanySecretList\x12\x1a.core.CompanySecretListReq\x1a\x1b.core.CompanySecretListResp\x12<\n" +
	"\x14getCompanySecretById\x12\v.core.IDReq\x1a\x17.core.CompanySecretInfo\x123\n" +
	"\x13deleteCompanySecret\x12\f.core.IDsReq\x1a\x0e.core.BaseResp\x12@\n" +
	...
	"\vgetUserList\x12\x11.core.UserListReq\x1a\x12.core.UserListResp\x126\n" +
	"\x11getUserByUsername\x12\x11.core.UsernameReq\x1a\x0e.core.UserInfo\x12,\n" +
	"\vgetUserById\x12\r.core.UUIDReq\x1a\x0e.core.UserInfo\x12,\n" +
	"\n" +
	"deleteUser\x12\x0e.core.UUIDsReq\x1a\x0e.core.BaseRespB\bZ\x06./coreb\x06proto3"
