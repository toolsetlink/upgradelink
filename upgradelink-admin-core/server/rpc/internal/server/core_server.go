...
import (
	...
	"upgradelink-admin-core/server/rpc/internal/logic/api"
	"upgradelink-admin-core/server/rpc/internal/logic/authority"
	"upgradelink-admin-core/server/rpc/internal/logic/base"
	"upgradelink-admin-core/server/rpc/internal/logic/company"
	"upgradelink-admin-core/server/rpc/internal/logic/company_secret"
	"upgradelink-admin-core/server/rpc/internal/logic/configuration"
	"upgradelink-admin-core/server/rpc/internal/logic/department"
	"upgradelink-admin-core/server/rpc/internal/logic/dictionary"
	"upgradelink-admin-core/server/rpc/internal/logic/dictionarydetail"
	"upgradelink-admin-core/server/rpc/internal/logic/menu"
	"upgradelink-admin-core/server/rpc/internal/logic/oauthprovider"
	"upgradelink-admin-core/server/rpc/internal/logic/position"
	"upgradelink-admin-core/server/rpc/internal/logic/role"
	"upgradelink-admin-core/server/rpc/internal/logic/token"
	"upgradelink-admin-core/server/rpc/internal/logic/user"
...
// Company management
func (s *CoreServer) CreateCompany(ctx context.Context, in *core.CompanyInfo) (*core.BaseIDResp, error) {
	l := company.NewCreateCompanyLogic(ctx, s.svcCtx)
	return l.CreateCompany(in)
}

func (s *CoreServer) UpdateCompany(ctx context.Context, in *core.CompanyInfo) (*core.BaseResp, error) {
	l := company.NewUpdateCompanyLogic(ctx, s.svcCtx)
	return l.UpdateCompany(in)
}

func (s *CoreServer) GetCompanyList(ctx context.Context, in *core.CompanyListReq) (*core.CompanyListResp, error) {
	l := company.NewGetCompanyListLogic(ctx, s.svcCtx)
	return l.GetCompanyList(in)
}

func (s *CoreServer) GetCompanyById(ctx context.Context, in *core.IDReq) (*core.CompanyInfo, error) {
	l := company.NewGetCompanyByIdLogic(ctx, s.svcCtx)
	return l.GetCompanyById(in)
}

func (s *CoreServer) DeleteCompany(ctx context.Context, in *core.IDsReq) (*core.BaseResp, error) {
	l := company.NewDeleteCompanyLogic(ctx, s.svcCtx)
	return l.DeleteCompany(in)
}

// CompanySecret management
func (s *CoreServer) CreateCompanySecret(ctx context.Context, in *core.CompanySecretInfo) (*core.BaseIDResp, error) {
	l := company_secret.NewCreateCompanySecretLogic(ctx, s.svcCtx)
	return l.CreateCompanySecret(in)
}

func (s *CoreServer) UpdateCompanySecret(ctx context.Context, in *core.CompanySecretInfo) (*core.BaseResp, error) {
	l := company_secret.NewUpdateCompanySecretLogic(ctx, s.svcCtx)
	return l.UpdateCompanySecret(in)
}

func (s *CoreServer) GetCompanySecretList(ctx context.Context, in *core.CompanySecretListReq) (*core.CompanySecretListResp, error) {
	l := company_secret.NewGetCompanySecretListLogic(ctx, s.svcCtx)
	return l.GetCompanySecretList(in)
}

func (s *CoreServer) GetCompanySecretById(ctx context.Context, in *core.IDReq) (*core.CompanySecretInfo, error) {
	l := company_secret.NewGetCompanySecretByIdLogic(ctx, s.svcCtx)
	return l.GetCompanySecretById(in)
}

func (s *CoreServer) DeleteCompanySecret(ctx context.Context, in *core.IDsReq) (*core.BaseResp, error) {
	l := company_secret.NewDeleteCompanySecretLogic(ctx, s.svcCtx)
	return l.DeleteCompanySecret(in)
}
