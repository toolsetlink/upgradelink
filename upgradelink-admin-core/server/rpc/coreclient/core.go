...
type (
	...
	CompanyInfo              = core.CompanyInfo
	CompanyListReq           = core.CompanyListReq
	CompanyListResp          = core.CompanyListResp
	CompanySecretInfo        = core.CompanySecretInfo
	CompanySecretListReq     = core.CompanySecretListReq
	CompanySecretListResp    = core.CompanySecretListResp
...
// Company management
func (m *defaultCore) CreateCompany(ctx context.Context, in *CompanyInfo, opts ...grpc.CallOption) (*BaseIDResp, error) {
	client := core.NewCoreClient(m.cli.Conn())
	return client.CreateCompany(ctx, in, opts...)
}

func (m *defaultCore) UpdateCompany(ctx context.Context, in *CompanyInfo, opts ...grpc.CallOption) (*BaseResp, error) {
	client := core.NewCoreClient(m.cli.Conn())
	return client.UpdateCompany(ctx, in, opts...)
}

func (m *defaultCore) GetCompanyList(ctx context.Context, in *CompanyListReq, opts ...grpc.CallOption) (*CompanyListResp, error) {
	client := core.NewCoreClient(m.cli.Conn())
	return client.GetCompanyList(ctx, in, opts...)
}

func (m *defaultCore) GetCompanyById(ctx context.Context, in *IDReq, opts ...grpc.CallOption) (*CompanyInfo, error) {
	client := core.NewCoreClient(m.cli.Conn())
	return client.GetCompanyById(ctx, in, opts...)
}

func (m *defaultCore) DeleteCompany(ctx context.Context, in *IDsReq, opts ...grpc.CallOption) (*BaseResp, error) {
	client := core.NewCoreClient(m.cli.Conn())
	return client.DeleteCompany(ctx, in, opts...)
}

// CompanySecret management
func (m *defaultCore) CreateCompanySecret(ctx context.Context, in *CompanySecretInfo, opts ...grpc.CallOption) (*BaseIDResp, error) {
	client := core.NewCoreClient(m.cli.Conn())
	return client.CreateCompanySecret(ctx, in, opts...)
}

func (m *defaultCore) UpdateCompanySecret(ctx context.Context, in *CompanySecretInfo, opts ...grpc.CallOption) (*BaseResp, error) {
	client := core.NewCoreClient(m.cli.Conn())
	return client.UpdateCompanySecret(ctx, in, opts...)
}

func (m *defaultCore) GetCompanySecretList(ctx context.Context, in *CompanySecretListReq, opts ...grpc.CallOption) (*CompanySecretListResp, error) {
	client := core.NewCoreClient(m.cli.Conn())
	return client.GetCompanySecretList(ctx, in, opts...)
}

func (m *defaultCore) GetCompanySecretById(ctx context.Context, in *IDReq, opts ...grpc.CallOption) (*CompanySecretInfo, error) {
	client := core.NewCoreClient(m.cli.Conn())
	return client.GetCompanySecretById(ctx, in, opts...)
}

func (m *defaultCore) DeleteCompanySecret(ctx context.Context, in *IDsReq, opts ...grpc.CallOption) (*BaseResp, error) {
	client := core.NewCoreClient(m.cli.Conn())
	return client.DeleteCompanySecret(ctx, in, opts...)
}
