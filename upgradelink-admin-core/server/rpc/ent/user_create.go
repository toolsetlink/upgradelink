...
func (uc *UserCreate) SetCompanyID(u uint64) *UserCreate {
	uc.mutation.SetCompanyID(u)
	return uc
}

// SetNillableCompanyID sets the "company_id" field if the given value is not nil.
func (uc *UserCreate) SetNillableCompanyID(u *uint64) *UserCreate {
	if u != nil {
		uc.SetCompanyID(*u)
	}
	return uc
...
func (uc *UserCreate) defaults() error {
	...
	if _, ok := uc.mutation.CompanyID(); !ok {
		v := user.DefaultCompanyID
		uc.mutation.SetCompanyID(v)
	}
