...
import (
	...
	"upgradelink-admin-core/server/rpc/ent/migrate"
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.API, c.Company, c.CompanySecret, c.Configuration, c.Department, c.Dictionary,
		c.DictionaryDetail, c.Menu, c.OauthProvider, c.Position, c.Role, c.Token,
		c.User,
	} {
		n.Use(hooks...)
	}
...
// UpdateOne returns an update builder for the given entity.
func (c *CompanySecretClient) UpdateOne(cs *CompanySecret) *CompanySecretUpdateOne {
	mutation := newCompanySecretMutation(c.config, OpUpdateOne, withCompanySecret(cs))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *CompanySecretClient) DeleteOne(cs *CompanySecret) *CompanySecretDeleteOne {
...
type (
	hooks struct {
		API, Company, CompanySecret, Configuration, Department, Dictionary,
		DictionaryDetail, Menu, OauthProvider, Position, Role, Token, User []ent.Hook
	}
	inters struct {
		API, Company, CompanySecret, Configuration, Department, Dictionary,
		DictionaryDetail, Menu, OauthProvider, Position, Role, Token,
