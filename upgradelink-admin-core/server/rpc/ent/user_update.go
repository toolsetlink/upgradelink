...
func (uu *UserUpdate) SetCompanyID(u uint64) *UserUpdate {
...
func (uu *UserUpdate) SetNillableCompanyID(u *uint64) *UserUpdate {
	if u != nil {
		uu.SetCompanyID(*u)
	}
	return uu
...
func (uu *UserUpdate) AddCompanyID(u int64) *UserUpdate {
	uu.mutation.AddCompanyID(u)
	return uu
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.CompanyID(); ok {
		_spec.SetField(user.FieldCompanyID, field.TypeUint64, value)
	}
	if value, ok := uu.mutation.AddedCompanyID(); ok {
		_spec.AddField(user.FieldCompanyID, field.TypeUint64, value)
	}
	if uu.mutation.CompanyIDCleared() {
		_spec.ClearField(user.FieldCompanyID, field.TypeUint64)
	}
...
// SetCompanyID sets the "company_id" field.
func (uuo *UserUpdateOne) SetCompanyID(u uint64) *UserUpdateOne {
...
// SetNillableCompanyID sets the "company_id" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableCompanyID(u *uint64) *UserUpdateOne {
	if u != nil {
		uuo.SetCompanyID(*u)
	}
	return uuo
...
// AddCompanyID adds u to the "company_id" field.
func (uuo *UserUpdateOne) AddCompanyID(u int64) *UserUpdateOne {
	uuo.mutation.AddCompanyID(u)
	return uuo
}
