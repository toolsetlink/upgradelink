...
const (
	...
	TypeAPI              = "API"
	TypeCompany          = "Company"
	TypeCompanySecret    = "CompanySecret"
...
// companysecretOption allows management of the mutation configuration using functional options.
type companysecretOption func(*CompanySecretMutation)

// newCompanySecretMutation creates new mutation for the CompanySecret entity.
func newCompanySecretMutation(c config, op Op, opts ...companysecretOption) *CompanySecretMutation {
	m := &CompanySecretMutation{
		config:        c,
		op:            op,
		typ:           TypeCompanySecret,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withCompanySecretID sets the ID field of the mutation.
func withCompanySecretID(id uint64) companysecretOption {
	return func(m *CompanySecretMutation) {
		var (
			err   error
			once  sync.Once
			value *CompanySecret
		)
		m.oldValue = func(ctx context.Context) (*CompanySecret, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().CompanySecret.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withCompanySecret sets the old CompanySecret of the mutation.
func withCompanySecret(node *CompanySecret) companysecretOption {
	return func(m *CompanySecretMutation) {
		m.oldValue = func(context.Context) (*CompanySecret, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m CompanySecretMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m CompanySecretMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of CompanySecret entities.
func (m *CompanySecretMutation) SetID(id uint64) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *CompanySecretMutation) ID() (id uint64, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *CompanySecretMutation) IDs(ctx context.Context) ([]uint64, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().CompanySecret.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetCreatedAt sets the "created_at" field.
func (m *CompanySecretMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *CompanySecretMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the CompanySecret entity.
// If the CompanySecret object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CompanySecretMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *CompanySecretMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *CompanySecretMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *CompanySecretMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the CompanySecret entity.
// If the CompanySecret object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CompanySecretMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *CompanySecretMutation) ResetUpdatedAt() {
	m.updated_at = nil
}

// SetCompanyID sets the "company_id" field.
func (m *CompanySecretMutation) SetCompanyID(u uint64) {
	m.company_id = &u
	m.addcompany_id = nil
}

// CompanyID returns the value of the "company_id" field in the mutation.
func (m *CompanySecretMutation) CompanyID() (r uint64, exists bool) {
	v := m.company_id
	if v == nil {
		return
	}
...
// OldCompanyID returns the old "company_id" field's value of the CompanySecret entity.
// If the CompanySecret object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CompanySecretMutation) OldCompanyID(ctx context.Context) (v uint64, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CompanySecretMutation) AddCompanyID(u int64) {
...
func (m *CompanySecretMutation) AddedCompanyID() (r int64, exists bool) {
	v := m.addcompany_id
	if v == nil {
		return
	}
...
func (m *CompanySecretMutation) ClearCompanyID() {
	m.company_id = nil
	m.addcompany_id = nil
	m.clearedFields[companysecret.FieldCompanyID] = struct{}{}
}

// CompanyIDCleared returns if the "company_id" field was cleared in this mutation.
func (m *CompanySecretMutation) CompanyIDCleared() bool {
	_, ok := m.clearedFields[companysecret.FieldCompanyID]
	return ok
}

// ResetCompanyID resets all changes to the "company_id" field.
func (m *CompanySecretMutation) ResetCompanyID() {
	m.company_id = nil
	m.addcompany_id = nil
	delete(m.clearedFields, companysecret.FieldCompanyID)
}

// SetAccessKey sets the "access_key" field.
func (m *CompanySecretMutation) SetAccessKey(s string) {
	m.access_key = &s
}

// AccessKey returns the value of the "access_key" field in the mutation.
func (m *CompanySecretMutation) AccessKey() (r string, exists bool) {
	v := m.access_key
	if v == nil {
		return
	}
...
// OldAccessKey returns the old "access_key" field's value of the CompanySecret entity.
// If the CompanySecret object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CompanySecretMutation) OldAccessKey(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CompanySecretMutation) ResetAccessKey() {
	m.access_key = nil
}

// SetSecretKey sets the "secret_key" field.
func (m *CompanySecretMutation) SetSecretKey(s string) {
	m.secret_key = &s
}

// SecretKey returns the value of the "secret_key" field in the mutation.
func (m *CompanySecretMutation) SecretKey() (r string, exists bool) {
	v := m.secret_key
	if v == nil {
		return
	}
...
// OldSecretKey returns the old "secret_key" field's value of the CompanySecret entity.
// If the CompanySecret object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CompanySecretMutation) OldSecretKey(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CompanySecretMutation) ResetSecretKey() {
	m.secret_key = nil
}
...
// WhereP appends storage-level predicates to the CompanySecretMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *CompanySecretMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.CompanySecret, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *CompanySecretMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *CompanySecretMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (CompanySecret).
func (m *CompanySecretMutation) Type() string {
	return m.typ
}
...
func (m *CompanySecretMutation) Fields() []string {
	...
	if m.updated_at != nil {
		fields = append(fields, companysecret.FieldUpdatedAt)
	}
	if m.company_id != nil {
		fields = append(fields, companysecret.FieldCompanyID)
	}
	if m.access_key != nil {
		fields = append(fields, companysecret.FieldAccessKey)
	}
	if m.secret_key != nil {
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *CompanySecretMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *CompanySecretMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case companysecret.FieldCreatedAt:
		return m.OldCreatedAt(ctx)
	case companysecret.FieldUpdatedAt:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *CompanySecretMutation) SetField(name string, value ent.Value) error {
	switch name {
	case companysecret.FieldCreatedAt:
		v, ok := value.(time.Time)
		if !ok {
...
// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *CompanySecretMutation) AddedFields() []string {
	var fields []string
	if m.addcompany_id != nil {
		fields = append(fields, companysecret.FieldCompanyID)
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *CompanySecretMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case companysecret.FieldCompanyID:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *CompanySecretMutation) AddField(name string, value ent.Value) error {
	switch name {
	case companysecret.FieldCompanyID:
		v, ok := value.(int64)
		if !ok {
...
// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *CompanySecretMutation) ClearedFields() []string {
	var fields []string
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *CompanySecretMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *CompanySecretMutation) ClearField(name string) error {
	switch name {
	case companysecret.FieldCompanyID:
		m.ClearCompanyID()
		return nil
...
// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *CompanySecretMutation) ResetField(name string) error {
	switch name {
	case companysecret.FieldCreatedAt:
		m.ResetCreatedAt()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *CompanySecretMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *CompanySecretMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *CompanySecretMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *CompanySecretMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *CompanySecretMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *CompanySecretMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *CompanySecretMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown CompanySecret unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *CompanySecretMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown CompanySecret edge %s", name)
}
...
// SetCompanyID sets the "company_id" field.
func (m *UserMutation) SetCompanyID(u uint64) {
	m.company_id = &u
	m.addcompany_id = nil
}

// CompanyID returns the value of the "company_id" field in the mutation.
func (m *UserMutation) CompanyID() (r uint64, exists bool) {
	v := m.company_id
	if v == nil {
		return
	}
...
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldCompanyID(ctx context.Context) (v uint64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCompanyID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddCompanyID adds u to the "company_id" field.
func (m *UserMutation) AddCompanyID(u int64) {
	if m.addcompany_id != nil {
		*m.addcompany_id += u
	} else {
		m.addcompany_id = &u
