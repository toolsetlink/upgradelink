...
import (
	...
	api "upgradelink-admin-core/server/api/internal/handler/api"
	authority "upgradelink-admin-core/server/api/internal/handler/authority"
	base "upgradelink-admin-core/server/api/internal/handler/base"
	captcha "upgradelink-admin-core/server/api/internal/handler/captcha"
	company_secret "upgradelink-admin-core/server/api/internal/handler/company_secret"
	configuration "upgradelink-admin-core/server/api/internal/handler/configuration"
	department "upgradelink-admin-core/server/api/internal/handler/department"
	dictionary "upgradelink-admin-core/server/api/internal/handler/dictionary"
	dictionarydetail "upgradelink-admin-core/server/api/internal/handler/dictionarydetail"
	emaillog "upgradelink-admin-core/server/api/internal/handler/emaillog"
	emailprovider "upgradelink-admin-core/server/api/internal/handler/emailprovider"
	menu "upgradelink-admin-core/server/api/internal/handler/menu"
	messagesender "upgradelink-admin-core/server/api/internal/handler/messagesender"
	oauthprovider "upgradelink-admin-core/server/api/internal/handler/oauthprovider"
	position "upgradelink-admin-core/server/api/internal/handler/position"
	publicapi "upgradelink-admin-core/server/api/internal/handler/publicapi"
	publicuser "upgradelink-admin-core/server/api/internal/handler/publicuser"
	role "upgradelink-admin-core/server/api/internal/handler/role"
	smslog "upgradelink-admin-core/server/api/internal/handler/smslog"
	smsprovider "upgradelink-admin-core/server/api/internal/handler/smsprovider"
	task "upgradelink-admin-core/server/api/internal/handler/task"
	tasklog "upgradelink-admin-core/server/api/internal/handler/tasklog"
	token "upgradelink-admin-core/server/api/internal/handler/token"
	user "upgradelink-admin-core/server/api/internal/handler/user"
