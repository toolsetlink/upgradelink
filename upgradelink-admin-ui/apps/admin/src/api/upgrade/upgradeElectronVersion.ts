...
enum Api {
  CreateUpgradeElectronVersion = "/upgrade_electron_version/create",
  DeleteUpgradeElectronVersion = "/upgrade_electron_version/delete",
  GetUpgradeElectronVersionById = "/upgrade_electron_version",
  GetUpgradeElectronVersionList = "/upgrade_electron_version/list",
  UpdateUpgradeElectronVersion = "/upgrade_electron_version/update",
}
