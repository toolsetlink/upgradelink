...
enum Api {
  CreateUpgradeFileVersion = "/upgrade_file_version/create",
  DeleteUpgradeFileVersion = "/upgrade_file_version/delete",
  GetUpgradeFileVersionById = "/upgrade_file_version",
  GetUpgradeFileVersionList = "/upgrade_file_version/list",
  UpdateUpgradeFileVersion = "/upgrade_file_version/update",
}
