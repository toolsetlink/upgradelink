...
enum Api {
  CreateUpgradeCompanyTrafficPacket = "/upgrade_company_traffic_packet/create",
  DeleteUpgradeCompanyTrafficPacket = "/upgrade_company_traffic_packet/delete",
  GetUpgradeCompanyTrafficPacketById = "/upgrade_company_traffic_packet",
  GetUpgradeCompanyTrafficPacketList = "/upgrade_company_traffic_packet/list",
  UpdateUpgradeCompanyTrafficPacket = "/upgrade_company_traffic_packet/update",
}
