...
enum Api {
  CreateUpgradeDevModel = "/upgrade_dev_model/create",
  DeleteUpgradeDevModel = "/upgrade_dev_model/delete",
  GetUpgradeDevModelById = "/upgrade_dev_model",
  GetUpgradeDevModelList = "/upgrade_dev_model/list",
  UpdateUpgradeDevModel = "/upgrade_dev_model/update",
}
