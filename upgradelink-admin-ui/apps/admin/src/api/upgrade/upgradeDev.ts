...
enum Api {
  CreateUpgradeDev = "/upgrade_dev/create",
  DeleteUpgradeDev = "/upgrade_dev/delete",
  GetUpgradeDevById = "/upgrade_dev",
  GetUpgradeDevList = "/upgrade_dev/list",
  UpdateUpgradeDev = "/upgrade_dev/update",
}
