...
enum Api {
  CreateUpgradeDevGroup = "/upgrade_dev_group/create",
  DeleteUpgradeDevGroup = "/upgrade_dev_group/delete",
  GetUpgradeDevGroupById = "/upgrade_dev_group",
  GetUpgradeDevGroupList = "/upgrade_dev_group/list",
  UpdateUpgradeDevGroup = "/upgrade_dev_group/update",
}
