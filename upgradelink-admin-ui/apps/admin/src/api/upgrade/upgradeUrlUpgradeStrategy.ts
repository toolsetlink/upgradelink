...
enum Api {
  CreateUpgradeUrlUpgradeStrategy = "/upgrade_url_upgrade_strategy/create",
  DeleteUpgradeUrlUpgradeStrategy = "/upgrade_url_upgrade_strategy/delete",
  GetUpgradeUrlUpgradeStrategyById = "/upgrade_url_upgrade_strategy",
  GetUpgradeUrlUpgradeStrategyList = "/upgrade_url_upgrade_strategy/list",
  UpdateUpgradeUrlUpgradeStrategy = "/upgrade_url_upgrade_strategy/update",
}
