...
enum Api {
  CreateUpgradeUrlVersion = "/upgrade_url_version/create",
  DeleteUpgradeUrlVersion = "/upgrade_url_version/delete",
  GetUpgradeUrlVersionById = "/upgrade_url_version",
  GetUpgradeUrlVersionList = "/upgrade_url_version/list",
  UpdateUpgradeUrlVersion = "/upgrade_url_version/update",
}
