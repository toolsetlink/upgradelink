...
enum Api {
  CreateUpgradeElectron = "/upgrade_electron/create",
  DeleteUpgradeElectron = "/upgrade_electron/delete",
  GetUpgradeElectronById = "/upgrade_electron",
  GetUpgradeElectronList = "/upgrade_electron/list",
  UpdateUpgradeElectron = "/upgrade_electron/update",
}
