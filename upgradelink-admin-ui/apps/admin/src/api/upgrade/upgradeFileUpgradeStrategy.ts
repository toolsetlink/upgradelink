...
enum Api {
  CreateUpgradeFileUpgradeStrategy = "/upgrade_file_upgrade_strategy/create",
  DeleteUpgradeFileUpgradeStrategy = "/upgrade_file_upgrade_strategy/delete",
  GetUpgradeFileUpgradeStrategyById = "/upgrade_file_upgrade_strategy",
  GetUpgradeFileUpgradeStrategyList = "/upgrade_file_upgrade_strategy/list",
  UpdateUpgradeFileUpgradeStrategy = "/upgrade_file_upgrade_strategy/update",
}
