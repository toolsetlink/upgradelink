...
enum Api {
  CreateUpgradeApk = "/upgrade_apk/create",
  DeleteUpgradeApk = "/upgrade_apk/delete",
  GetUpgradeApkById = "/upgrade_apk",
  GetUpgradeApkList = "/upgrade_apk/list",
  UpdateUpgradeApk = "/upgrade_apk/update",
}
