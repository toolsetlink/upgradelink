...
enum Api {
  CreateUpgradeConfigurationVersion = "/upgrade_configuration_version/create",
  DeleteUpgradeConfigurationVersion = "/upgrade_configuration_version/delete",
  GetUpgradeConfigurationVersionById = "/upgrade_configuration_version",
  GetUpgradeConfigurationVersionList = "/upgrade_configuration_version/list",
  UpdateUpgradeConfigurationVersion = "/upgrade_configuration_version/update",
}
