...
enum Api {
  CreateUpgradeConfiguration = "/upgrade_configuration/create",
  DeleteUpgradeConfiguration = "/upgrade_configuration/delete",
  GetUpgradeConfigurationById = "/upgrade_configuration",
  GetUpgradeConfigurationList = "/upgrade_configuration/list",
  UpdateUpgradeConfiguration = "/upgrade_configuration/update",
}
