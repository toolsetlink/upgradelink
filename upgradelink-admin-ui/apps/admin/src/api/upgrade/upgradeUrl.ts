...
enum Api {
  CreateUpgradeUrl = "/upgrade_url/create",
  DeleteUpgradeUrl = "/upgrade_url/delete",
  GetUpgradeUrlById = "/upgrade_url",
  GetUpgradeUrlList = "/upgrade_url/list",
  UpdateUpgradeUrl = "/upgrade_url/update",
}
