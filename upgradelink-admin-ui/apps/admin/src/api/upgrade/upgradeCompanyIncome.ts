...
enum Api {
  CreateUpgradeCompanyIncome = "/upgrade_company_income/create",
  DeleteUpgradeCompanyIncome = "/upgrade_company_income/delete",
  GetUpgradeCompanyIncomeById = "/upgrade_company_income",
  GetUpgradeCompanyIncomeList = "/upgrade_company_income/list",
  UpdateUpgradeCompanyIncome = "/upgrade_company_income/update",
}
