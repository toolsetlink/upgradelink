...
enum Api {
  CreateUpgradeApkUpgradeStrategy = "/upgrade_apk_upgrade_strategy/create",
  DeleteUpgradeApkUpgradeStrategy = "/upgrade_apk_upgrade_strategy/delete",
  GetUpgradeApkUpgradeStrategyById = "/upgrade_apk_upgrade_strategy",
  GetUpgradeApkUpgradeStrategyList = "/upgrade_apk_upgrade_strategy/list",
  UpdateUpgradeApkUpgradeStrategy = "/upgrade_apk_upgrade_strategy/update",
}
