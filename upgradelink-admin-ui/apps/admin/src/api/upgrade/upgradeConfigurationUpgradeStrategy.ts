...
enum Api {
  CreateUpgradeConfigurationUpgradeStrategy = "/upgrade_configuration_upgrade_strategy/create",
  DeleteUpgradeConfigurationUpgradeStrategy = "/upgrade_configuration_upgrade_strategy/delete",
  GetUpgradeConfigurationUpgradeStrategyById = "/upgrade_configuration_upgrade_strategy",
  GetUpgradeConfigurationUpgradeStrategyList = "/upgrade_configuration_upgrade_strategy/list",
  UpdateUpgradeConfigurationUpgradeStrategy = "/upgrade_configuration_upgrade_strategy/update",
}
