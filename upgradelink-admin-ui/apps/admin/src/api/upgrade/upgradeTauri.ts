...
enum Api {
  CreateUpgradeTauri = "/upgrade_tauri/create",
  DeleteUpgradeTauri = "/upgrade_tauri/delete",
  GetUpgradeTauriById = "/upgrade_tauri",
  GetUpgradeTauriList = "/upgrade_tauri/list",
  UpdateUpgradeTauri = "/upgrade_tauri/update",
}
