...
enum Api {
  CreateUpgradeTauriVersion = "/upgrade_tauri_version/create",
  DeleteUpgradeTauriVersion = "/upgrade_tauri_version/delete",
  GetUpgradeTauriVersionById = "/upgrade_tauri_version",
  GetUpgradeTauriVersionList = "/upgrade_tauri_version/list",
  UpdateUpgradeTauriVersion = "/upgrade_tauri_version/update",
}
