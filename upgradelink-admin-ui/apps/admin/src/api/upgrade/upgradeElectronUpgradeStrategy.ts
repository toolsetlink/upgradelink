...
enum Api {
  CreateUpgradeElectronUpgradeStrategy = "/upgrade_electron_upgrade_strategy/create",
  DeleteUpgradeElectronUpgradeStrategy = "/upgrade_electron_upgrade_strategy/delete",
  GetUpgradeElectronUpgradeStrategyById = "/upgrade_electron_upgrade_strategy",
  GetUpgradeElectronUpgradeStrategyList = "/upgrade_electron_upgrade_strategy/list",
  UpdateUpgradeElectronUpgradeStrategy = "/upgrade_electron_upgrade_strategy/update",
}
