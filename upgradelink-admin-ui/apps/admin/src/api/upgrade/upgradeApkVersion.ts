...
enum Api {
  CreateUpgradeApkVersion = "/upgrade_apk_version/create",
  DeleteUpgradeApkVersion = "/upgrade_apk_version/delete",
  GetUpgradeApkVersionById = "/upgrade_apk_version",
  GetUpgradeApkVersionList = "/upgrade_apk_version/list",
  UpdateUpgradeApkVersion = "/upgrade_apk_version/update",
}
