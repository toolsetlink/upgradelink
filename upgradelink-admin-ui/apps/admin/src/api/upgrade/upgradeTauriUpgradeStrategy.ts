...
enum Api {
  CreateUpgradeTauriUpgradeStrategy = "/upgrade_tauri_upgrade_strategy/create",
  DeleteUpgradeTauriUpgradeStrategy = "/upgrade_tauri_upgrade_strategy/delete",
  GetUpgradeTauriUpgradeStrategyById = "/upgrade_tauri_upgrade_strategy",
  GetUpgradeTauriUpgradeStrategyList = "/upgrade_tauri_upgrade_strategy/list",
  UpdateUpgradeTauriUpgradeStrategy = "/upgrade_tauri_upgrade_strategy/update",
}
