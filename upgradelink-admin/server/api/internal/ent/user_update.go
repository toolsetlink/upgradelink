...
func (_u *UserUpdate) SetCompanyID(v uint64) *UserUpdate {
...
func (_u *UserUpdate) SetNillableCompanyID(v *uint64) *UserUpdate {
	if v != nil {
		_u.SetCompanyID(*v)
	}
	return _u
...
// SetCompanyID sets the "company_id" field.
func (_u *UserUpdateOne) SetCompanyID(v uint64) *UserUpdateOne {
	_u.mutation.ResetCompanyID()
	_u.mutation.SetCompanyID(v)
	return _u
}
...
// SetNillableCompanyID sets the "company_id" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableCompanyID(v *uint64) *UserUpdateOne {
	if v != nil {
		_u.SetCompanyID(*v)
	}
	return _u
