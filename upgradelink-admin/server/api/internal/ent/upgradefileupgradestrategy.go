...
func (_m *UpgradeFileUpgradeStrategy) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case upgradefileupgradestrategy.FieldFileVersionID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				_m.FileVersionID = int(value.Int64)
			}
...
func (_m *UpgradeFileUpgradeStrategy) Value(name string) (ent.Value, error) {
...
func (_m *UpgradeFileUpgradeStrategy) Update() *UpgradeFileUpgradeStrategyUpdateOne {
	return NewUpgradeFileUpgradeStrategyClient(_m.config).UpdateOne(_m)
}
...
func (_m *UpgradeFileUpgradeStrategy) Unwrap() *UpgradeFileUpgradeStrategy {
...
func (_m *UpgradeFileUpgradeStrategy) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", _m.FileVersionID))
	builder.WriteString(", ")
