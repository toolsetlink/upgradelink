...
func (_m *UpgradeConfigurationUpgradeStrategyGrayStrategy) assignValues(columns []string, values []any) error {
...
func (_m *UpgradeConfigurationUpgradeStrategyGrayStrategy) Value(name string) (ent.Value, error) {
...
func (_m *UpgradeConfigurationUpgradeStrategyGrayStrategy) Update() *UpgradeConfigurationUpgradeStrategyGrayStrategyUpdateOne {
	return NewUpgradeConfigurationUpgradeStrategyGrayStrategyClient(_m.config).UpdateOne(_m)
}
...
func (_m *UpgradeConfigurationUpgradeStrategyGrayStrategy) Unwrap() *UpgradeConfigurationUpgradeStrategyGrayStrategy {
...
func (_m *UpgradeConfigurationUpgradeStrategyGrayStrategy) String() string {
