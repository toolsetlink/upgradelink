...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			companysecret.Table:             companysecret.ValidColumn,
			fmscloudfile.Table:              fmscloudfile.ValidColumn,
			menu.Table:                      menu.ValidColumn,
			role.Table:                      role.ValidColumn,
			token.Table:                     token.ValidColumn,
			upgradeapk.Table:                upgradeapk.ValidColumn,
			upgradeapkupgradestrategy.Table: upgradeapkupgradestrategy.ValidColumn,
			upgradeapkupgradestrategyflowlimitstrategy.Table:           upgradeapkupgradestrategyflowlimitstrategy.ValidColumn,
			upgradeapkupgradestrategygraystrategy.Table:                upgradeapkupgradestrategygraystrategy.ValidColumn,
			upgradeapkversion.Table:                                    upgradeapkversion.ValidColumn,
			upgradeappdownloadreportlog.Table:                          upgradeappdownloadreportlog.ValidColumn,
			upgradecompanyincome.Table:                                 upgradecompanyincome.ValidColumn,
			upgradecompanytrafficpacket.Table:                          upgradecompanytrafficpacket.ValidColumn,
			upgradeconfiguration.Table:                                 upgradeconfiguration.ValidColumn,
			upgradeconfigurationupgradestrategy.Table:                  upgradeconfigurationupgradestrategy.ValidColumn,
			upgradeconfigurationupgradestrategyflowlimitstrategy.Table: upgradeconfigurationupgradestrategyflowlimitstrategy.ValidColumn,
			upgradeconfigurationupgradestrategygraystrategy.Table:      upgradeconfigurationupgradestrategygraystrategy.ValidColumn,
			upgradeconfigurationversion.Table:                          upgradeconfigurationversion.ValidColumn,
			upgradedev.Table:                                           upgradedev.ValidColumn,
			upgradedevgroup.Table:                                      upgradedevgroup.ValidColumn,
			upgradedevgrouprelation.Table:                              upgradedevgrouprelation.ValidColumn,
			upgradedevmodel.Table:                                      upgradedevmodel.ValidColumn,
			upgradeelectron.Table:                                      upgradeelectron.ValidColumn,
			upgradeelectronupgradestrategy.Table:                       upgradeelectronupgradestrategy.ValidColumn,
			upgradeelectronupgradestrategyflowlimitstrategy.Table:      upgradeelectronupgradestrategyflowlimitstrategy.ValidColumn,
			upgradeelectronupgradestrategygraystrategy.Table:           upgradeelectronupgradestrategygraystrategy.ValidColumn,
			upgradeelectronversion.Table:                               upgradeelectronversion.ValidColumn,
			upgradefile.Table:                                          upgradefile.ValidColumn,
			upgradefileupgradestrategy.Table:                           upgradefileupgradestrategy.ValidColumn,
			...
			upgradetauriupgradestrategygraystrategy.Table:              upgradetauriupgradestrategygraystrategy.ValidColumn,
			upgradetauriversion.Table:                                  upgradetauriversion.ValidColumn,
			upgradetrafficpacket.Table:                                 upgradetrafficpacket.ValidColumn,
			upgradeurl.Table:                                           upgradeurl.ValidColumn,
			upgradeurlupgradestrategy.Table:                            upgradeurlupgradestrategy.ValidColumn,
