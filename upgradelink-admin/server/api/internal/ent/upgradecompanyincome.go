...
func (_m *UpgradeCompanyIncome) assignValues(columns []string, values []any) error {
...
func (_m *UpgradeCompanyIncome) Value(name string) (ent.Value, error) {
...
func (_m *UpgradeCompanyIncome) Update() *UpgradeCompanyIncomeUpdateOne {
	return NewUpgradeCompanyIncomeClient(_m.config).UpdateOne(_m)
}
...
func (_m *UpgradeCompanyIncome) Unwrap() *UpgradeCompanyIncome {
...
func (_m *UpgradeCompanyIncome) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", _m.IncomeType))
	builder.WriteString(", ")
	builder.WriteString("income_amount=")
	builder.WriteString(fmt.Sprintf("%v", _m.IncomeAmount))
	builder.WriteString(", ")
	builder.WriteString("income_time=")
	builder.WriteString(_m.IncomeTime.Format(time.ANSIC))
	builder.WriteString(", ")
