...
const (
	// Label holds the string label denoting the upgradelnxupgradestrategy type in the database.
	Label = "upgrade_lnx_upgrade_strategy"
	...
	FieldLnxID = "lnx_id"
	// FieldLnxVersionID holds the string denoting the lnx_version_id field in the database.
	FieldLnxVersionID = "lnx_version_id"
	...
	// Table holds the table name of the upgradelnxupgradestrategy in the database.
	Table = "upgrade_lnx_upgrade_strategy"
)

// Columns holds all SQL columns for upgradelnxupgradestrategy fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldEnable,
...
// OrderOption defines the ordering options for the UpgradeLnxUpgradeStrategy queries.
...
// ByLnxVersionID orders the results by the lnx_version_id field.
func ByLnxVersionID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldLnxVersionID, opts...).ToFunc()
}
