...
func (_m *UpgradeConfigurationUpgradeStrategy) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case upgradeconfigurationupgradestrategy.FieldConfigurationVersionID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				_m.ConfigurationVersionID = int(value.Int64)
			}
...
func (_m *UpgradeConfigurationUpgradeStrategy) Value(name string) (ent.Value, error) {
...
func (_m *UpgradeConfigurationUpgradeStrategy) Update() *UpgradeConfigurationUpgradeStrategyUpdateOne {
	return NewUpgradeConfigurationUpgradeStrategyClient(_m.config).UpdateOne(_m)
}
...
func (_m *UpgradeConfigurationUpgradeStrategy) Unwrap() *UpgradeConfigurationUpgradeStrategy {
...
func (_m *UpgradeConfigurationUpgradeStrategy) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", _m.ConfigurationVersionID))
	builder.WriteString(", ")
