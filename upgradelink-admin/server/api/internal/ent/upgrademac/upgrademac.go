...
const (
	// Label holds the string label denoting the upgrademac type in the database.
	Label = "upgrade_mac"
	...
	// Table holds the table name of the upgrademac in the database.
	Table = "upgrade_mac"
)

// Columns holds all SQL columns for upgrademac fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldKey,
...
// OrderOption defines the ordering options for the UpgradeMac queries.
