...
const (
	// Label holds the string label denoting the upgradewinversion type in the database.
	Label = "upgrade_win_version"
	...
	// Table holds the table name of the upgradewinversion in the database.
	Table = "upgrade_win_version"
)

// Columns holds all SQL columns for upgradewinversion fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldWinID,
...
// OrderOption defines the ordering options for the UpgradeWinVersion queries.
