...
func (_m *UpgradeTrafficPacket) assignValues(columns []string, values []any) error {
...
func (_m *UpgradeTrafficPacket) Value(name string) (ent.Value, error) {
...
func (_m *UpgradeTrafficPacket) Update() *UpgradeTrafficPacketUpdateOne {
	return NewUpgradeTrafficPacketClient(_m.config).UpdateOne(_m)
}
...
func (_m *UpgradeTrafficPacket) Unwrap() *UpgradeTrafficPacket {
...
func (_m *UpgradeTrafficPacket) String() string {
