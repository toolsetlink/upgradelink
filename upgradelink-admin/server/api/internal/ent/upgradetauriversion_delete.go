...
func (_d *UpgradeTauriVersionDelete) Where(ps ...predicate.UpgradeTauriVersion) *UpgradeTauriVersionDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *UpgradeTauriVersionDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *UpgradeTauriVersionDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *UpgradeTauriVersionDelete) sqlExec(ctx context.Context) (int, error) {
...
type UpgradeTauriVersionDeleteOne struct {
	_d *UpgradeTauriVersionDelete
}

// Where appends a list predicates to the UpgradeTauriVersionDelete builder.
func (_d *UpgradeTauriVersionDeleteOne) Where(ps ...predicate.UpgradeTauriVersion) *UpgradeTauriVersionDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *UpgradeTauriVersionDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *UpgradeTauriVersionDeleteOne) ExecX(ctx context.Context) {
