...
func (_m *UpgradeMacUpgradeStrategy) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case upgrademacupgradestrategy.FieldMACVersionID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				_m.MACVersionID = int(value.Int64)
			}
...
func (_m *UpgradeMacUpgradeStrategy) Value(name string) (ent.Value, error) {
...
func (_m *UpgradeMacUpgradeStrategy) Update() *UpgradeMacUpgradeStrategyUpdateOne {
	return NewUpgradeMacUpgradeStrategyClient(_m.config).UpdateOne(_m)
}
...
func (_m *UpgradeMacUpgradeStrategy) Unwrap() *UpgradeMacUpgradeStrategy {
...
func (_m *UpgradeMacUpgradeStrategy) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", _m.MACVersionID))
	builder.WriteString(", ")
