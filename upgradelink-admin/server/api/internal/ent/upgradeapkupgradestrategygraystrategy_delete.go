...
func (_d *UpgradeApkUpgradeStrategyGrayStrategyDelete) Where(ps ...predicate.UpgradeApkUpgradeStrategyGrayStrategy) *UpgradeApkUpgradeStrategyGrayStrategyDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *UpgradeApkUpgradeStrategyGrayStrategyDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *UpgradeApkUpgradeStrategyGrayStrategyDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *UpgradeApkUpgradeStrategyGrayStrategyDelete) sqlExec(ctx context.Context) (int, error) {
...
type UpgradeApkUpgradeStrategyGrayStrategyDeleteOne struct {
	_d *UpgradeApkUpgradeStrategyGrayStrategyDelete
}

// Where appends a list predicates to the UpgradeApkUpgradeStrategyGrayStrategyDelete builder.
func (_d *UpgradeApkUpgradeStrategyGrayStrategyDeleteOne) Where(ps ...predicate.UpgradeApkUpgradeStrategyGrayStrategy) *UpgradeApkUpgradeStrategyGrayStrategyDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *UpgradeApkUpgradeStrategyGrayStrategyDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *UpgradeApkUpgradeStrategyGrayStrategyDeleteOne) ExecX(ctx context.Context) {
