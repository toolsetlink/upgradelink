...
const (
	// Label holds the string label denoting the upgradelnxupgradestrategygraystrategy type in the database.
	Label = "upgrade_lnx_upgrade_strategy_gray_strategy"
	...
	// Table holds the table name of the upgradelnxupgradestrategygraystrategy in the database.
	Table = "upgrade_lnx_upgrade_strategy_gray_strategy"
)

// Columns holds all SQL columns for upgradelnxupgradestrategygraystrategy fields.
var Columns = []string{
	FieldID,
	FieldEnable,
	FieldBeginDatetime,
...
// OrderOption defines the ordering options for the UpgradeLnxUpgradeStrategyGrayStrategy queries.
