...
func (_d *UpgradeFileVersionDelete) Where(ps ...predicate.UpgradeFileVersion) *UpgradeFileVersionDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *UpgradeFileVersionDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *UpgradeFileVersionDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *UpgradeFileVersionDelete) sqlExec(ctx context.Context) (int, error) {
...
type UpgradeFileVersionDeleteOne struct {
	_d *UpgradeFileVersionDelete
}

// Where appends a list predicates to the UpgradeFileVersionDelete builder.
func (_d *UpgradeFileVersionDeleteOne) Where(ps ...predicate.UpgradeFileVersion) *UpgradeFileVersionDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *UpgradeFileVersionDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *UpgradeFileVersionDeleteOne) ExecX(ctx context.Context) {
