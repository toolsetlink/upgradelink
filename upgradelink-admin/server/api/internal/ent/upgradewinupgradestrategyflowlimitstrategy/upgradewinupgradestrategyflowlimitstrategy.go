...
const (
	// Label holds the string label denoting the upgradewinupgradestrategyflowlimitstrategy type in the database.
	Label = "upgrade_win_upgrade_strategy_flow_limit_strategy"
	...
	// Table holds the table name of the upgradewinupgradestrategyflowlimitstrategy in the database.
	Table = "upgrade_win_upgrade_strategy_flow_limit_strategy"
)

// Columns holds all SQL columns for upgradewinupgradestrategyflowlimitstrategy fields.
var Columns = []string{
	FieldID,
	FieldEnable,
	FieldBeginTime,
...
// OrderOption defines the ordering options for the UpgradeWinUpgradeStrategyFlowLimitStrategy queries.
