...
func (_m *UpgradeUrlUpgradeStrategy) assignValues(columns []string, values []any) error {
...
func (_m *UpgradeUrlUpgradeStrategy) Value(name string) (ent.Value, error) {
...
func (_m *UpgradeUrlUpgradeStrategy) Update() *UpgradeUrlUpgradeStrategyUpdateOne {
	return NewUpgradeUrlUpgradeStrategyClient(_m.config).UpdateOne(_m)
}
...
func (_m *UpgradeUrlUpgradeStrategy) Unwrap() *UpgradeUrlUpgradeStrategy {
...
func (_m *UpgradeUrlUpgradeStrategy) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", _m.URLID))
	builder.WriteString(", ")
	builder.WriteString("url_version_id=")
	builder.WriteString(fmt.Sprintf("%v", _m.URLVersionID))
	builder.WriteString(", ")
