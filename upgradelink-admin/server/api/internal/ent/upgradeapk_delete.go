...
func (_d *UpgradeApkDelete) Where(ps ...predicate.UpgradeApk) *UpgradeApkDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *UpgradeApkDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *UpgradeApkDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *UpgradeApkDelete) sqlExec(ctx context.Context) (int, error) {
...
// Where appends a list predicates to the UpgradeApkDelete builder.
func (_d *UpgradeApkDeleteOne) Where(ps ...predicate.UpgradeApk) *UpgradeApkDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *UpgradeApkDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *UpgradeApkDeleteOne) ExecX(ctx context.Context) {
