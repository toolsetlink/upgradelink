...
func (_d *UpgradeUrlUpgradeStrategyFlowLimitStrategyDelete) Where(ps ...predicate.UpgradeUrlUpgradeStrategyFlowLimitStrategy) *UpgradeUrlUpgradeStrategyFlowLimitStrategyDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *UpgradeUrlUpgradeStrategyFlowLimitStrategyDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *UpgradeUrlUpgradeStrategyFlowLimitStrategyDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *UpgradeUrlUpgradeStrategyFlowLimitStrategyDelete) sqlExec(ctx context.Context) (int, error) {
...
type UpgradeUrlUpgradeStrategyFlowLimitStrategyDeleteOne struct {
	_d *UpgradeUrlUpgradeStrategyFlowLimitStrategyDelete
}

// Where appends a list predicates to the UpgradeUrlUpgradeStrategyFlowLimitStrategyDelete builder.
func (_d *UpgradeUrlUpgradeStrategyFlowLimitStrategyDeleteOne) Where(ps ...predicate.UpgradeUrlUpgradeStrategyFlowLimitStrategy) *UpgradeUrlUpgradeStrategyFlowLimitStrategyDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *UpgradeUrlUpgradeStrategyFlowLimitStrategyDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *UpgradeUrlUpgradeStrategyFlowLimitStrategyDeleteOne) ExecX(ctx context.Context) {
