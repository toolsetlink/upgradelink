...
const (
	// Label holds the string label denoting the upgradeurlupgradestrategy type in the database.
	Label = "upgrade_url_upgrade_strategy"
	...
	FieldURLID = "url_id"
	// FieldURLVersionID holds the string denoting the url_version_id field in the database.
	FieldURLVersionID = "url_version_id"
	...
	// Table holds the table name of the upgradeurlupgradestrategy in the database.
	Table = "upgrade_url_upgrade_strategy"
)

// Columns holds all SQL columns for upgradeurlupgradestrategy fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldEnable,
...
// OrderOption defines the ordering options for the UpgradeUrlUpgradeStrategy queries.
...
// ByURLVersionID orders the results by the url_version_id field.
func ByURLVersionID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldURLVersionID, opts...).ToFunc()
}
