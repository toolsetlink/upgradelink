...
func (_d *UpgradeElectronVersionDelete) Where(ps ...predicate.UpgradeElectronVersion) *UpgradeElectronVersionDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *UpgradeElectronVersionDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *UpgradeElectronVersionDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *UpgradeElectronVersionDelete) sqlExec(ctx context.Context) (int, error) {
...
type UpgradeElectronVersionDeleteOne struct {
	_d *UpgradeElectronVersionDelete
}

// Where appends a list predicates to the UpgradeElectronVersionDelete builder.
func (_d *UpgradeElectronVersionDeleteOne) Where(ps ...predicate.UpgradeElectronVersion) *UpgradeElectronVersionDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *UpgradeElectronVersionDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *UpgradeElectronVersionDeleteOne) ExecX(ctx context.Context) {
