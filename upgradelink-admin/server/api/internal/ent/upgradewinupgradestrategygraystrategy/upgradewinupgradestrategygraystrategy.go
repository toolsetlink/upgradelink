...
const (
	// Label holds the string label denoting the upgradewinupgradestrategygraystrategy type in the database.
	Label = "upgrade_win_upgrade_strategy_gray_strategy"
	...
	// Table holds the table name of the upgradewinupgradestrategygraystrategy in the database.
	Table = "upgrade_win_upgrade_strategy_gray_strategy"
)

// Columns holds all SQL columns for upgradewinupgradestrategygraystrategy fields.
var Columns = []string{
	FieldID,
	FieldEnable,
	FieldBeginDatetime,
...
// OrderOption defines the ordering options for the UpgradeWinUpgradeStrategyGrayStrategy queries.
