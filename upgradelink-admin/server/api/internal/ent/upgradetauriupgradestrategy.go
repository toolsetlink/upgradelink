...
func (_m *UpgradeTauriUpgradeStrategy) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case upgradetauriupgradestrategy.FieldTauriVersionID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				_m.TauriVersionID = int(value.Int64)
			}
...
func (_m *UpgradeTauriUpgradeStrategy) Value(name string) (ent.Value, error) {
...
func (_m *UpgradeTauriUpgradeStrategy) Update() *UpgradeTauriUpgradeStrategyUpdateOne {
	return NewUpgradeTauriUpgradeStrategyClient(_m.config).UpdateOne(_m)
}
...
func (_m *UpgradeTauriUpgradeStrategy) Unwrap() *UpgradeTauriUpgradeStrategy {
...
func (_m *UpgradeTauriUpgradeStrategy) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", _m.TauriID))
	builder.WriteString(", ")
	builder.WriteString("tauri_version_id=")
	builder.WriteString(fmt.Sprintf("%v", _m.TauriVersionID))
	builder.WriteString(", ")
