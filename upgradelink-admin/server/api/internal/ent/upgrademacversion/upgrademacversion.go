...
const (
	// Label holds the string label denoting the upgrademacversion type in the database.
	Label = "upgrade_mac_version"
	...
	// Table holds the table name of the upgrademacversion in the database.
	Table = "upgrade_mac_version"
)

// Columns holds all SQL columns for upgrademacversion fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldMACID,
...
// OrderOption defines the ordering options for the UpgradeMacVersion queries.
