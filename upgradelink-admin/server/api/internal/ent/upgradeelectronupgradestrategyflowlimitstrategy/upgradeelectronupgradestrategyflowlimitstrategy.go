...
const (
	// Label holds the string label denoting the upgradeelectronupgradestrategyflowlimitstrategy type in the database.
	Label = "upgrade_electron_upgrade_strategy_flow_limit_strategy"
	...
	// Table holds the table name of the upgradeelectronupgradestrategyflowlimitstrategy in the database.
	Table = "upgrade_electron_upgrade_strategy_flow_limit_strategy"
)

// Columns holds all SQL columns for upgradeelectronupgradestrategyflowlimitstrategy fields.
var Columns = []string{
	FieldID,
	FieldEnable,
	FieldBeginTime,
...
// OrderOption defines the ordering options for the UpgradeElectronUpgradeStrategyFlowLimitStrategy queries.
