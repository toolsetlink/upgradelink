...
const (
	// Label holds the string label denoting the upgradelnxupgradestrategyflowlimitstrategy type in the database.
	Label = "upgrade_lnx_upgrade_strategy_flow_limit_strategy"
	...
	// Table holds the table name of the upgradelnxupgradestrategyflowlimitstrategy in the database.
	Table = "upgrade_lnx_upgrade_strategy_flow_limit_strategy"
)

// Columns holds all SQL columns for upgradelnxupgradestrategyflowlimitstrategy fields.
var Columns = []string{
	FieldID,
	FieldEnable,
	FieldBeginTime,
...
// OrderOption defines the ordering options for the UpgradeLnxUpgradeStrategyFlowLimitStrategy queries.
