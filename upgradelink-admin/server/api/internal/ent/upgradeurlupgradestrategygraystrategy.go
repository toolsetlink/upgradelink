...
func (_m *UpgradeUrlUpgradeStrategyGrayStrategy) assignValues(columns []string, values []any) error {
...
func (_m *UpgradeUrlUpgradeStrategyGrayStrategy) Value(name string) (ent.Value, error) {
...
func (_m *UpgradeUrlUpgradeStrategyGrayStrategy) Update() *UpgradeUrlUpgradeStrategyGrayStrategyUpdateOne {
	return NewUpgradeUrlUpgradeStrategyGrayStrategyClient(_m.config).UpdateOne(_m)
}
...
func (_m *UpgradeUrlUpgradeStrategyGrayStrategy) Unwrap() *UpgradeUrlUpgradeStrategyGrayStrategy {
...
func (_m *UpgradeUrlUpgradeStrategyGrayStrategy) String() string {
