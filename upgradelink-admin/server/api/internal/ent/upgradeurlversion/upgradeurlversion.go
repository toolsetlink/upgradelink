...
const (
	// Label holds the string label denoting the upgradeurlversion type in the database.
	Label = "upgrade_url_version"
	...
	// Table holds the table name of the upgradeurlversion in the database.
	Table = "upgrade_url_version"
)

// Columns holds all SQL columns for upgradeurlversion fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldURLID,
...
// OrderOption defines the ordering options for the UpgradeUrlVersion queries.
