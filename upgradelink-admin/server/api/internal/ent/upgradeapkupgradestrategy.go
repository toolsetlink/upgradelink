...
func (_m *UpgradeApkUpgradeStrategy) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case upgradeapkupgradestrategy.FieldApkVersionID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				_m.ApkVersionID = int(value.Int64)
			}
...
func (_m *UpgradeApkUpgradeStrategy) Value(name string) (ent.Value, error) {
...
func (_m *UpgradeApkUpgradeStrategy) Update() *UpgradeApkUpgradeStrategyUpdateOne {
	return NewUpgradeApkUpgradeStrategyClient(_m.config).UpdateOne(_m)
}
...
func (_m *UpgradeApkUpgradeStrategy) Unwrap() *UpgradeApkUpgradeStrategy {
...
func (_m *UpgradeApkUpgradeStrategy) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", _m.ApkVersionID))
	builder.WriteString(", ")
