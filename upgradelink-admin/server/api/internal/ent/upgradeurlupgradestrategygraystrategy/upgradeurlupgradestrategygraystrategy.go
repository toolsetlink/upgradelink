...
const (
	// Label holds the string label denoting the upgradeurlupgradestrategygraystrategy type in the database.
	Label = "upgrade_url_upgrade_strategy_gray_strategy"
	...
	// Table holds the table name of the upgradeurlupgradestrategygraystrategy in the database.
	Table = "upgrade_url_upgrade_strategy_gray_strategy"
)

// Columns holds all SQL columns for upgradeurlupgradestrategygraystrategy fields.
var Columns = []string{
	FieldID,
	FieldEnable,
	FieldBeginDatetime,
...
// OrderOption defines the ordering options for the UpgradeUrlUpgradeStrategyGrayStrategy queries.
