...
func (_d *UpgradeConfigurationUpgradeStrategyDelete) Where(ps ...predicate.UpgradeConfigurationUpgradeStrategy) *UpgradeConfigurationUpgradeStrategyDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *UpgradeConfigurationUpgradeStrategyDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *UpgradeConfigurationUpgradeStrategyDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *UpgradeConfigurationUpgradeStrategyDelete) sqlExec(ctx context.Context) (int, error) {
...
type UpgradeConfigurationUpgradeStrategyDeleteOne struct {
	_d *UpgradeConfigurationUpgradeStrategyDelete
}

// Where appends a list predicates to the UpgradeConfigurationUpgradeStrategyDelete builder.
func (_d *UpgradeConfigurationUpgradeStrategyDeleteOne) Where(ps ...predicate.UpgradeConfigurationUpgradeStrategy) *UpgradeConfigurationUpgradeStrategyDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *UpgradeConfigurationUpgradeStrategyDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *UpgradeConfigurationUpgradeStrategyDeleteOne) ExecX(ctx context.Context) {
