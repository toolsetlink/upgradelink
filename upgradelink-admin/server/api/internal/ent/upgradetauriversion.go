...
func (_m *UpgradeTauriVersion) assignValues(columns []string, values []any) error {
...
func (_m *UpgradeTauriVersion) Value(name string) (ent.Value, error) {
...
func (_m *UpgradeTauriVersion) Update() *UpgradeTauriVersionUpdateOne {
	return NewUpgradeTauriVersionClient(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the UpgradeTauriVersion entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *UpgradeTauriVersion) Unwrap() *UpgradeTauriVersion {
...
func (_m *UpgradeTauriVersion) String() string {
