...
func (UpgradeWinVersion) Fields() []ent.Field {
	return []ent.Field{
...
func (UpgradeWinVersion) Edges() []ent.Edge {
	return nil
}

func (UpgradeWinVersion) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "upgrade_win_version"},
	}
}
