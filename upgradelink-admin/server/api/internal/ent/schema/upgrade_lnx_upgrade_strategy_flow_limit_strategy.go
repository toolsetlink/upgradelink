...
type UpgradeLnxUpgradeStrategyFlowLimitStrategy struct {
	ent.Schema
}

func (UpgradeLnxUpgradeStrategyFlowLimitStrategy) Fields() []ent.Field {
	return []ent.Field{
...
func (UpgradeLnxUpgradeStrategyFlowLimitStrategy) Edges() []ent.Edge {
	return nil
}

func (UpgradeLnxUpgradeStrategyFlowLimitStrategy) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "upgrade_lnx_upgrade_strategy_flow_limit_strategy"},
	}
}
