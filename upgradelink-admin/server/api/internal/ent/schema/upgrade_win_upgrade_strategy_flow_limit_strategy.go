...
type UpgradeWinUpgradeStrategyFlowLimitStrategy struct {
	ent.Schema
}

func (UpgradeWinUpgradeStrategyFlowLimitStrategy) Fields() []ent.Field {
	return []ent.Field{
...
func (UpgradeWinUpgradeStrategyFlowLimitStrategy) Edges() []ent.Edge {
	return nil
}

func (UpgradeWinUpgradeStrategyFlowLimitStrategy) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "upgrade_win_upgrade_strategy_flow_limit_strategy"},
	}
}
