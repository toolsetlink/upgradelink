...
func (UpgradeMacUpgradeStrategy) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Int("mac_version_id").Comment("mac_version_id; 外键mac_version.id"),
...
func (UpgradeMacUpgradeStrategy) Edges() []ent.Edge {
	return nil
}

func (UpgradeMacUpgradeStrategy) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "upgrade_mac_upgrade_strategy"},
	}
}
