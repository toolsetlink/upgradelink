...
func (UpgradeUrlUpgradeStrategy) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Int("url_version_id").Comment("url_version_id; 外键url_version.id"),
...
func (UpgradeUrlUpgradeStrategy) Edges() []ent.Edge {
	return nil
}

func (UpgradeUrlUpgradeStrategy) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "upgrade_url_upgrade_strategy"},
	}
}
