...
func (UpgradeFileVersion) Fields() []ent.Field {
	return []ent.Field{
...
func (UpgradeFileVersion) Edges() []ent.Edge {
	return nil
}

func (UpgradeFileVersion) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "upgrade_file_version"},
	}
}
