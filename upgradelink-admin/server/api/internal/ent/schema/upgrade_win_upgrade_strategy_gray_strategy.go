...
type UpgradeWinUpgradeStrategyGrayStrategy struct {
	ent.Schema
}

func (UpgradeWinUpgradeStrategyGrayStrategy) Fields() []ent.Field {
	return []ent.Field{
...
func (UpgradeWinUpgradeStrategyGrayStrategy) Edges() []ent.Edge {
	return nil
}

func (UpgradeWinUpgradeStrategyGrayStrategy) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "upgrade_win_upgrade_strategy_gray_strategy"},
	}
}
