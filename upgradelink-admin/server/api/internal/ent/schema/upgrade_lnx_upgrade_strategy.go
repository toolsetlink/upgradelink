...
type UpgradeLnxUpgradeStrategy struct {
	ent.Schema
}

func (UpgradeLnxUpgradeStrategy) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Int("lnx_id").Comment("linux应用ID"),
		field.Int("lnx_version_id").Comment("lnx_version_id; 外键lnx_version.id"),
...
func (UpgradeLnxUpgradeStrategy) Edges() []ent.Edge {
	return nil
}

func (UpgradeLnxUpgradeStrategy) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "upgrade_lnx_upgrade_strategy"},
	}
}
