...
func (UpgradeApkUpgradeStrategyGrayStrategy) Fields() []ent.Field {
	return []ent.Field{
...
func (UpgradeApkUpgradeStrategyGrayStrategy) Edges() []ent.Edge {
	return nil
}

func (UpgradeApkUpgradeStrategyGrayStrategy) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "upgrade_apk_upgrade_strategy_gray_strategy"},
	}
}
