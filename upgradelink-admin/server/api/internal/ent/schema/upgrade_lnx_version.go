...
func (UpgradeLnxVersion) Fields() []ent.Field {
	return []ent.Field{
		field.Int("id").Comment("ID"),
		field.Int("company_id").Comment("公司ID"),
		field.Int("lnx_id").Comment("lnx应用ID"),
...
func (UpgradeLnxVersion) Edges() []ent.Edge {
	return nil
}

func (UpgradeLnxVersion) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "upgrade_lnx_version"},
	}
}
