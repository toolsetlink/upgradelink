...
const (
	// Label holds the string label denoting the upgradeelectronupgradestrategygraystrategy type in the database.
	Label = "upgrade_electron_upgrade_strategy_gray_strategy"
	...
	// Table holds the table name of the upgradeelectronupgradestrategygraystrategy in the database.
	Table = "upgrade_electron_upgrade_strategy_gray_strategy"
)

// Columns holds all SQL columns for upgradeelectronupgradestrategygraystrategy fields.
var Columns = []string{
	FieldID,
	FieldEnable,
	FieldBeginDatetime,
...
// OrderOption defines the ordering options for the UpgradeElectronUpgradeStrategyGrayStrategy queries.
