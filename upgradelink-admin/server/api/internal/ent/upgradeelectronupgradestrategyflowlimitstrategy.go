...
func (_m *UpgradeElectronUpgradeStrategyFlowLimitStrategy) assignValues(columns []string, values []any) error {
...
func (_m *UpgradeElectronUpgradeStrategyFlowLimitStrategy) Value(name string) (ent.Value, error) {
...
func (_m *UpgradeElectronUpgradeStrategyFlowLimitStrategy) Update() *UpgradeElectronUpgradeStrategyFlowLimitStrategyUpdateOne {
	return NewUpgradeElectronUpgradeStrategyFlowLimitStrategyClient(_m.config).UpdateOne(_m)
}
...
func (_m *UpgradeElectronUpgradeStrategyFlowLimitStrategy) Unwrap() *UpgradeElectronUpgradeStrategyFlowLimitStrategy {
...
func (_m *UpgradeElectronUpgradeStrategyFlowLimitStrategy) String() string {
