...
const (
	// Label holds the string label denoting the upgrademacupgradestrategy type in the database.
	Label = "upgrade_mac_upgrade_strategy"
	...
	// FieldMACID holds the string denoting the mac_id field in the database.
	FieldMACID = "mac_id"
	// FieldMACVersionID holds the string denoting the mac_version_id field in the database.
	FieldMACVersionID = "mac_version_id"
	...
	// Table holds the table name of the upgrademacupgradestrategy in the database.
	Table = "upgrade_mac_upgrade_strategy"
)

// Columns holds all SQL columns for upgrademacupgradestrategy fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldEnable,
...
// OrderOption defines the ordering options for the UpgradeMacUpgradeStrategy queries.
...
// ByMACID orders the results by the mac_id field.
func ByMACID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldMACID, opts...).ToFunc()
}

// ByMACVersionID orders the results by the mac_version_id field.
func ByMACVersionID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldMACVersionID, opts...).ToFunc()
}
