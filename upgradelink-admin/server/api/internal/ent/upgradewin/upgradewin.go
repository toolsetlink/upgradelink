...
const (
	// Label holds the string label denoting the upgradewin type in the database.
	Label = "upgrade_win"
	...
	// Table holds the table name of the upgradewin in the database.
	Table = "upgrade_win"
)

// Columns holds all SQL columns for upgradewin fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldKey,
...
// OrderOption defines the ordering options for the UpgradeWin queries.
