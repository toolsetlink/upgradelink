...
const (
	// Label holds the string label denoting the upgradefileupgradestrategygraystrategy type in the database.
	Label = "upgrade_file_upgrade_strategy_gray_strategy"
	...
	// Table holds the table name of the upgradefileupgradestrategygraystrategy in the database.
	Table = "upgrade_file_upgrade_strategy_gray_strategy"
)

// Columns holds all SQL columns for upgradefileupgradestrategygraystrategy fields.
var Columns = []string{
	FieldID,
	FieldEnable,
	FieldBeginDatetime,
...
// OrderOption defines the ordering options for the UpgradeFileUpgradeStrategyGrayStrategy queries.
