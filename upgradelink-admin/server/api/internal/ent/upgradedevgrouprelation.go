...
func (_m *UpgradeDevGroupRelation) assignValues(columns []string, values []any) error {
...
func (_m *UpgradeDevGroupRelation) Value(name string) (ent.Value, error) {
...
func (_m *UpgradeDevGroupRelation) Update() *UpgradeDevGroupRelationUpdateOne {
	return NewUpgradeDevGroupRelationClient(_m.config).UpdateOne(_m)
}
...
func (_m *UpgradeDevGroupRelation) Unwrap() *UpgradeDevGroupRelation {
...
func (_m *UpgradeDevGroupRelation) String() string {
	var builder strings.Builder
	builder.WriteString("UpgradeDevGroupRelation(")
	builder.WriteString(fmt.Sprintf("id=%v, ", _m.ID))
	builder.WriteString("dev_id=")
	builder.WriteString(fmt.Sprintf("%v", _m.DevID))
	builder.WriteString(", ")
	builder.WriteString("dev_group_id=")
	builder.WriteString(fmt.Sprintf("%v", _m.DevGroupID))
	builder.WriteString(", ")
