...
const (
	// Label holds the string label denoting the upgradeelectronupgradestrategy type in the database.
	Label = "upgrade_electron_upgrade_strategy"
	...
	// FieldElectronID holds the string denoting the electron_id field in the database.
	FieldElectronID = "electron_id"
	// FieldElectronVersionID holds the string denoting the electron_version_id field in the database.
	FieldElectronVersionID = "electron_version_id"
	...
	// Table holds the table name of the upgradeelectronupgradestrategy in the database.
	Table = "upgrade_electron_upgrade_strategy"
)

// Columns holds all SQL columns for upgradeelectronupgradestrategy fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldEnable,
...
// OrderOption defines the ordering options for the UpgradeElectronUpgradeStrategy queries.
...
// ByElectronID orders the results by the electron_id field.
func ByElectronID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldElectronID, opts...).ToFunc()
}

// ByElectronVersionID orders the results by the electron_version_id field.
func ByElectronVersionID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldElectronVersionID, opts...).ToFunc()
}
