...
func (_m *UpgradeElectronVersion) assignValues(columns []string, values []any) error {
...
func (_m *UpgradeElectronVersion) Value(name string) (ent.Value, error) {
...
func (_m *UpgradeElectronVersion) Update() *UpgradeElectronVersionUpdateOne {
	return NewUpgradeElectronVersionClient(_m.config).UpdateOne(_m)
}
...
func (_m *UpgradeElectronVersion) Unwrap() *UpgradeElectronVersion {
...
func (_m *UpgradeElectronVersion) String() string {
	...
	builder.WriteString(_m.InstallCloudFileID)
	builder.WriteString(", ")
	builder.WriteString("install_sha512=")
	builder.WriteString(_m.InstallSha512)
	builder.WriteString(", ")
