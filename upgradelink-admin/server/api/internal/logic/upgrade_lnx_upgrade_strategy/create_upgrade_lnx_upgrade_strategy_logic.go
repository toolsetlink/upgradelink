...
type CreateUpgradeLnxUpgradeStrategyLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewCreateUpgradeLnxUpgradeStrategyLogic(ctx context.Context, svcCtx *svc.ServiceContext) *CreateUpgradeLnxUpgradeStrategyLogic {
	return &CreateUpgradeLnxUpgradeStrategyLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
func (l *CreateUpgradeLnxUpgradeStrategyLogic) CreateUpgradeLnxUpgradeStrategy(req *types.UpgradeLnxUpgradeStrategyInfo) (*types.BaseMsgResp, error) {

	// 效验请求参数数据
	err := l.CheckCreateUpgradeLnxUpgradeStrategy(req)
	if err != nil {
		return nil, err
	}
	...
	if err := entx.WithTx(l.ctx, l.svcCtx.DB, func(tx *ent.Tx) error {
		...
		_, err = l.svcCtx.DB.UpgradeLnxUpgradeStrategy.Create().
...
func (l *CreateUpgradeLnxUpgradeStrategyLogic) CheckCreateUpgradeLnxUpgradeStrategy(req *types.UpgradeLnxUpgradeStrategyInfo) error {
	// 判断是否重复
