...
type CreateUpgradeMacUpgradeStrategyLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewCreateUpgradeMacUpgradeStrategyLogic(ctx context.Context, svcCtx *svc.ServiceContext) *CreateUpgradeMacUpgradeStrategyLogic {
	return &CreateUpgradeMacUpgradeStrategyLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
func (l *CreateUpgradeMacUpgradeStrategyLogic) CreateUpgradeMacUpgradeStrategy(req *types.UpgradeMacUpgradeStrategyInfo) (*types.BaseMsgResp, error) {

	// 效验请求参数数据
	err := l.CheckCreateUpgradeMacUpgradeStrategy(req)
	if err != nil {
		return nil, err
	}
	...
	if err := entx.WithTx(l.ctx, l.svcCtx.DB, func(tx *ent.Tx) error {
		...
		_, err = l.svcCtx.DB.UpgradeMacUpgradeStrategy.Create().
...
func (l *CreateUpgradeMacUpgradeStrategyLogic) CheckCreateUpgradeMacUpgradeStrategy(req *types.UpgradeMacUpgradeStrategyInfo) error {
	// 判断是否重复
