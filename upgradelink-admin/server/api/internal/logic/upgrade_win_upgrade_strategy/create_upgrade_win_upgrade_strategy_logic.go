...
type CreateUpgradeWinUpgradeStrategyLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewCreateUpgradeWinUpgradeStrategyLogic(ctx context.Context, svcCtx *svc.ServiceContext) *CreateUpgradeWinUpgradeStrategyLogic {
	return &CreateUpgradeWinUpgradeStrategyLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
func (l *CreateUpgradeWinUpgradeStrategyLogic) CreateUpgradeWinUpgradeStrategy(req *types.UpgradeWinUpgradeStrategyInfo) (*types.BaseMsgResp, error) {

	// 效验请求参数数据
	err := l.CheckCreateUpgradeWinUpgradeStrategy(req)
	if err != nil {
		return nil, err
	}
	...
	if err := entx.WithTx(l.ctx, l.svcCtx.DB, func(tx *ent.Tx) error {
		...
		_, err = l.svcCtx.DB.UpgradeWinUpgradeStrategy.Create().
...
func (l *CreateUpgradeWinUpgradeStrategyLogic) CheckCreateUpgradeWinUpgradeStrategy(req *types.UpgradeWinUpgradeStrategyInfo) error {
	// 判断是否重复
