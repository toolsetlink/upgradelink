...
import (
	...
	base "upgradelink-admin-file/server/internal/handler/base"
	cloudfile "upgradelink-admin-file/server/internal/handler/cloudfile"
	cloudfiletag "upgradelink-admin-file/server/internal/handler/cloudfiletag"
	file "upgradelink-admin-file/server/internal/handler/file"
	filetag "upgradelink-admin-file/server/internal/handler/filetag"
	storageprovider "upgradelink-admin-file/server/internal/handler/storageprovider"
