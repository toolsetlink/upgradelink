...
type CreateUpgradeElectronUpgradeStrategyLogic struct {
	ctx    context.Context
...
func NewCreateUpgradeElectronUpgradeStrategyLogic(ctx context.Context, svcCtx *svc.ServiceContext) *CreateUpgradeElectronUpgradeStrategyLogic {
	return &CreateUpgradeElectronUpgradeStrategyLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
func (l *CreateUpgradeElectronUpgradeStrategyLogic) CreateUpgradeElectronUpgradeStrategy(req *types.UpgradeElectronUpgradeStrategyInfo) (*types.BaseMsgResp, error) {
	...
	// 效验请求参数数据
	err = l.CheckCreateUpgradeElectronUpgradeStrategy(req)
	if err != nil {
	...
	if err := base.WithTx(l.ctx, l.svcCtx.DB, func(tx *ent.Tx) error {
		...
		_, err = l.svcCtx.DB.UpgradeElectronUpgradeStrategy.Create().
...
func (l *CreateUpgradeElectronUpgradeStrategyLogic) CheckCreateUpgradeElectronUpgradeStrategy(req *types.UpgradeElectronUpgradeStrategyInfo) error {
	// 判断是否重复
