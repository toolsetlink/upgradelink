...
const (
	// Label holds the string label denoting the upgradefileupgradestrategyflowlimitstrategy type in the database.
	Label = "upgrade_file_upgrade_strategy_flow_limit_strategy"
	...
	// Table holds the table name of the upgradefileupgradestrategyflowlimitstrategy in the database.
	Table = "upgrade_file_upgrade_strategy_flow_limit_strategy"
)

// Columns holds all SQL columns for upgradefileupgradestrategyflowlimitstrategy fields.
var Columns = []string{
	FieldID,
	FieldEnable,
	FieldBeginTime,
...
// OrderOption defines the ordering options for the UpgradeFileUpgradeStrategyFlowLimitStrategy queries.
