...
const (
	// Label holds the string label denoting the upgradefile type in the database.
	Label = "upgrade_file"
	...
	// Table holds the table name of the upgradefile in the database.
	Table = "upgrade_file"
)

// Columns holds all SQL columns for upgradefile fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldKey,
...
// OrderOption defines the ordering options for the UpgradeFile queries.
