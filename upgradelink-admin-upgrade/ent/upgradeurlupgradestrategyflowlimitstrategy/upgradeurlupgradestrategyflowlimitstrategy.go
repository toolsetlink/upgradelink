...
const (
	// Label holds the string label denoting the upgradeurlupgradestrategyflowlimitstrategy type in the database.
	Label = "upgrade_url_upgrade_strategy_flow_limit_strategy"
	...
	// Table holds the table name of the upgradeurlupgradestrategyflowlimitstrategy in the database.
	Table = "upgrade_url_upgrade_strategy_flow_limit_strategy"
)

// Columns holds all SQL columns for upgradeurlupgradestrategyflowlimitstrategy fields.
var Columns = []string{
	FieldID,
	FieldEnable,
	FieldBeginTime,
...
// OrderOption defines the ordering options for the UpgradeUrlUpgradeStrategyFlowLimitStrategy queries.
