...
const (
	// Label holds the string label denoting the upgradeconfiguration type in the database.
	Label = "upgrade_configuration"
	...
	// Table holds the table name of the upgradeconfiguration in the database.
	Table = "upgrade_configuration"
)

// Columns holds all SQL columns for upgradeconfiguration fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldKey,
...
// OrderOption defines the ordering options for the UpgradeConfiguration queries.
