...
const (
	// Label holds the string label denoting the upgradeelectron type in the database.
	Label = "upgrade_electron"
	...
	// Table holds the table name of the upgradeelectron in the database.
	Table = "upgrade_electron"
)

// Columns holds all SQL columns for upgradeelectron fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldKey,
...
// OrderOption defines the ordering options for the UpgradeElectron queries.
