...
const (
	// Label holds the string label denoting the upgradeconfigurationupgradestrategygraystrategy type in the database.
	Label = "upgrade_configuration_upgrade_strategy_gray_strategy"
	...
	// Table holds the table name of the upgradeconfigurationupgradestrategygraystrategy in the database.
	Table = "upgrade_configuration_upgrade_strategy_gray_strategy"
)

// Columns holds all SQL columns for upgradeconfigurationupgradestrategygraystrategy fields.
var Columns = []string{
	FieldID,
	FieldEnable,
	FieldBeginDatetime,
...
// OrderOption defines the ordering options for the UpgradeConfigurationUpgradeStrategyGrayStrategy queries.
