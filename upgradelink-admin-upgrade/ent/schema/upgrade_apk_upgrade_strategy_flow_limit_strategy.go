...
func (UpgradeApkUpgradeStrategyFlowLimitStrategy) Fields() []ent.Field {
	return []ent.Field{
...
func (UpgradeApkUpgradeStrategyFlowLimitStrategy) Edges() []ent.Edge {
	return nil
}

func (UpgradeApkUpgradeStrategyFlowLimitStrategy) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "upgrade_apk_upgrade_strategy_flow_limit_strategy"},
	}
}
