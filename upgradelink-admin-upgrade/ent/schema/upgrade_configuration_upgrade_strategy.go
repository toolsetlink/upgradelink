...
func (UpgradeConfigurationUpgradeStrategy) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Int("configuration_id").Comment("配置ID"),
		field.Int("configuration_version_id").Comment("configuration_version_id; 外键configuration_version.id"),
...
func (UpgradeConfigurationUpgradeStrategy) Edges() []ent.Edge {
	return nil
}

func (UpgradeConfigurationUpgradeStrategy) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "upgrade_configuration_upgrade_strategy"},
	}
}
