...
func (UpgradeConfigurationUpgradeStrategyGrayStrategy) Fields() []ent.Field {
	return []ent.Field{
...
func (UpgradeConfigurationUpgradeStrategyGrayStrategy) Edges() []ent.Edge {
	return nil
}

func (UpgradeConfigurationUpgradeStrategyGrayStrategy) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "upgrade_configuration_upgrade_strategy_gray_strategy"},
	}
}
