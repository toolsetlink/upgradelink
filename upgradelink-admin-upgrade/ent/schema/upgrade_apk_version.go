...
func (UpgradeApkVersion) Fields() []ent.Field {
	return []ent.Field{
...
func (UpgradeApkVersion) Edges() []ent.Edge {
	return nil
}

func (UpgradeApkVersion) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "upgrade_apk_version"},
	}
}
