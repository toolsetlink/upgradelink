...
func (UpgradeConfigurationVersion) Fields() []ent.Field {
	return []ent.Field{
...
func (UpgradeConfigurationVersion) Edges() []ent.Edge {
	return nil
}

func (UpgradeConfigurationVersion) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "upgrade_configuration_version"},
	}
}
