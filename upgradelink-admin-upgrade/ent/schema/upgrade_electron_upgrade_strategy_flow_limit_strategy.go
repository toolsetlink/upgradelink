...
func (UpgradeElectronUpgradeStrategyFlowLimitStrategy) Fields() []ent.Field {
	return []ent.Field{
...
func (UpgradeElectronUpgradeStrategyFlowLimitStrategy) Edges() []ent.Edge {
	return nil
}

func (UpgradeElectronUpgradeStrategyFlowLimitStrategy) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "upgrade_electron_upgrade_strategy_flow_limit_strategy"},
	}
}
