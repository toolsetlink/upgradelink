...
func (UpgradeElectronUpgradeStrategy) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Int("electron_id").Comment("electron应用ID"),
		field.Int("electron_version_id").Comment("electron_version_id; 外键electron_version.id"),
...
func (UpgradeElectronUpgradeStrategy) Edges() []ent.Edge {
	return nil
}

func (UpgradeElectronUpgradeStrategy) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "upgrade_electron_upgrade_strategy"},
	}
}
