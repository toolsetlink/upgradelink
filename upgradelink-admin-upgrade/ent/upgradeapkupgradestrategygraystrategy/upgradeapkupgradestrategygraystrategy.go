...
const (
	// Label holds the string label denoting the upgradeapkupgradestrategygraystrategy type in the database.
	Label = "upgrade_apk_upgrade_strategy_gray_strategy"
	...
	// Table holds the table name of the upgradeapkupgradestrategygraystrategy in the database.
	Table = "upgrade_apk_upgrade_strategy_gray_strategy"
)

// Columns holds all SQL columns for upgradeapkupgradestrategygraystrategy fields.
var Columns = []string{
	FieldID,
	FieldEnable,
	FieldBeginDatetime,
...
// OrderOption defines the ordering options for the UpgradeApkUpgradeStrategyGrayStrategy queries.
