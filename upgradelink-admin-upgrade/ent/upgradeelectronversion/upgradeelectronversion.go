...
const (
	// Label holds the string label denoting the upgradeelectronversion type in the database.
	Label = "upgrade_electron_version"
	...
	// FieldInstallSha512 holds the string denoting the install_sha512 field in the database.
	FieldInstallSha512 = "install_sha512"
	...
	// Table holds the table name of the upgradeelectronversion in the database.
	Table = "upgrade_electron_version"
)

// Columns holds all SQL columns for upgradeelectronversion fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldElectronID,
...
// OrderOption defines the ordering options for the UpgradeElectronVersion queries.
...
// ByInstallSha512 orders the results by the install_sha512 field.
func ByInstallSha512(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldInstallSha512, opts...).ToFunc()
}
