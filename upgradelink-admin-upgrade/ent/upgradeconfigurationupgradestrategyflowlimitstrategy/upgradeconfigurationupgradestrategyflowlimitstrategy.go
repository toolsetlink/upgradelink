...
const (
	// Label holds the string label denoting the upgradeconfigurationupgradestrategyflowlimitstrategy type in the database.
	Label = "upgrade_configuration_upgrade_strategy_flow_limit_strategy"
	...
	// Table holds the table name of the upgradeconfigurationupgradestrategyflowlimitstrategy in the database.
	Table = "upgrade_configuration_upgrade_strategy_flow_limit_strategy"
)

// Columns holds all SQL columns for upgradeconfigurationupgradestrategyflowlimitstrategy fields.
var Columns = []string{
	FieldID,
	FieldEnable,
	FieldBeginTime,
...
// OrderOption defines the ordering options for the UpgradeConfigurationUpgradeStrategyFlowLimitStrategy queries.
