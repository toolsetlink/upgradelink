...
const (
	// Label holds the string label denoting the upgradetauriupgradestrategyflowlimitstrategy type in the database.
	Label = "upgrade_tauri_upgrade_strategy_flow_limit_strategy"
	...
	// Table holds the table name of the upgradetauriupgradestrategyflowlimitstrategy in the database.
	Table = "upgrade_tauri_upgrade_strategy_flow_limit_strategy"
)

// Columns holds all SQL columns for upgradetauriupgradestrategyflowlimitstrategy fields.
var Columns = []string{
	FieldID,
	FieldEnable,
	FieldBeginTime,
...
// OrderOption defines the ordering options for the UpgradeTauriUpgradeStrategyFlowLimitStrategy queries.
