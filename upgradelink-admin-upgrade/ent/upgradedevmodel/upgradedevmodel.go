...
const (
	// Label holds the string label denoting the upgradedevmodel type in the database.
	Label = "upgrade_dev_model"
	...
	// Table holds the table name of the upgradedevmodel in the database.
	Table = "upgrade_dev_model"
)

// Columns holds all SQL columns for upgradedevmodel fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldKey,
...
// OrderOption defines the ordering options for the UpgradeDevModel queries.
