...
const (
	// Label holds the string label denoting the upgradeapk type in the database.
	Label = "upgrade_apk"
	...
	// Table holds the table name of the upgradeapk in the database.
	Table = "upgrade_apk"
)

// Columns holds all SQL columns for upgradeapk fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldKey,
...
// OrderOption defines the ordering options for the UpgradeApk queries.
