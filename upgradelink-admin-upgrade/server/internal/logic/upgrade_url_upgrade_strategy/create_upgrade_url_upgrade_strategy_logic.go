...
type CreateUpgradeUrlUpgradeStrategyLogic struct {
	ctx    context.Context
...
func NewCreateUpgradeUrlUpgradeStrategyLogic(ctx context.Context, svcCtx *svc.ServiceContext) *CreateUpgradeUrlUpgradeStrategyLogic {
	return &CreateUpgradeUrlUpgradeStrategyLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
func (l *CreateUpgradeUrlUpgradeStrategyLogic) CreateUpgradeUrlUpgradeStrategy(req *types.UpgradeUrlUpgradeStrategyInfo) (*types.BaseMsgResp, error) {
	// 获取公司 id
	...
	// 效验请求参数数据
	err = l.CheckCreateUpgradeUrlUpgradeStrategy(req)
	if err != nil {
	...
	if err := base.WithTx(l.ctx, l.svcCtx.DB, func(tx *ent.Tx) error {
		...
		_, err = l.svcCtx.DB.UpgradeUrlUpgradeStrategy.Create().
...
func (l *CreateUpgradeUrlUpgradeStrategyLogic) CheckCreateUpgradeUrlUpgradeStrategy(req *types.UpgradeUrlUpgradeStrategyInfo) error {
	// 判断是否重复
	...
	predicates = append(predicates, upgradeurlupgradestrategy.CompanyIDEQ(l.companyID))
