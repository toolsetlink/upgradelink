...
import (
	...
	base "upgradelink-admin-upgrade/server/internal/handler/base"
	upgrade_apk "upgradelink-admin-upgrade/server/internal/handler/upgrade_apk"
	upgrade_apk_upgrade_strategy "upgradelink-admin-upgrade/server/internal/handler/upgrade_apk_upgrade_strategy"
	upgrade_apk_version "upgradelink-admin-upgrade/server/internal/handler/upgrade_apk_version"
	upgrade_company_income "upgradelink-admin-upgrade/server/internal/handler/upgrade_company_income"
	upgrade_company_traffic_packet "upgradelink-admin-upgrade/server/internal/handler/upgrade_company_traffic_packet"
	upgrade_configuration "upgradelink-admin-upgrade/server/internal/handler/upgrade_configuration"
	upgrade_configuration_upgrade_strategy "upgradelink-admin-upgrade/server/internal/handler/upgrade_configuration_upgrade_strategy"
	upgrade_configuration_version "upgradelink-admin-upgrade/server/internal/handler/upgrade_configuration_version"
	upgrade_dashboard "upgradelink-admin-upgrade/server/internal/handler/upgrade_dashboard"
	upgrade_dev "upgradelink-admin-upgrade/server/internal/handler/upgrade_dev"
	upgrade_dev_group "upgradelink-admin-upgrade/server/internal/handler/upgrade_dev_group"
	upgrade_dev_group_relation "upgradelink-admin-upgrade/server/internal/handler/upgrade_dev_group_relation"
	upgrade_dev_model "upgradelink-admin-upgrade/server/internal/handler/upgrade_dev_model"
	upgrade_electron "upgradelink-admin-upgrade/server/internal/handler/upgrade_electron"
	upgrade_electron_upgrade_strategy "upgradelink-admin-upgrade/server/internal/handler/upgrade_electron_upgrade_strategy"
	upgrade_electron_version "upgradelink-admin-upgrade/server/internal/handler/upgrade_electron_version"
