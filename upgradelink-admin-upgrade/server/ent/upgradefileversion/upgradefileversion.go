...
const (
	// Label holds the string label denoting the upgradefileversion type in the database.
	Label = "upgrade_file_version"
	...
	// Table holds the table name of the upgradefileversion in the database.
	Table = "upgrade_file_version"
)

// Columns holds all SQL columns for upgradefileversion fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldFileID,
...
// OrderOption defines the ordering options for the UpgradeFileVersion queries.
