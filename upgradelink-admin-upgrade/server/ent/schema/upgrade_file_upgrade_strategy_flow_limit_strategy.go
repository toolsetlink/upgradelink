...
func (UpgradeFileUpgradeStrategyFlowLimitStrategy) Fields() []ent.Field {
	return []ent.Field{
...
func (UpgradeFileUpgradeStrategyFlowLimitStrategy) Edges() []ent.Edge {
	return nil
}

func (UpgradeFileUpgradeStrategyFlowLimitStrategy) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "upgrade_file_upgrade_strategy_flow_limit_strategy"},
	}
}
