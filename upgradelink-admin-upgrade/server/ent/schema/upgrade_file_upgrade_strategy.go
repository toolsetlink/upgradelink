...
func (UpgradeFileUpgradeStrategy) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Int("file_id").Comment("文件应用ID"),
		field.Int("file_version_id").Comment("file_version_id; 外键file_version.id"),
...
func (UpgradeFileUpgradeStrategy) Edges() []ent.Edge {
	return nil
}

func (UpgradeFileUpgradeStrategy) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "upgrade_file_upgrade_strategy"},
	}
}
