...
func (UpgradeApkUpgradeStrategy) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Int("apk_id").Comment("安卓应用ID"),
		field.Int("apk_version_id").Comment("apk_version_id; 外键apk_version.id"),
...
func (UpgradeApkUpgradeStrategy) Edges() []ent.Edge {
	return nil
}

func (UpgradeApkUpgradeStrategy) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "upgrade_apk_upgrade_strategy"},
	}
}
