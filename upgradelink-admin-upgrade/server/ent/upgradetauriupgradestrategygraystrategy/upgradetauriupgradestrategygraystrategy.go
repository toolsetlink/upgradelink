...
const (
	// Label holds the string label denoting the upgradetauriupgradestrategygraystrategy type in the database.
	Label = "upgrade_tauri_upgrade_strategy_gray_strategy"
	...
	// Table holds the table name of the upgradetauriupgradestrategygraystrategy in the database.
	Table = "upgrade_tauri_upgrade_strategy_gray_strategy"
)

// Columns holds all SQL columns for upgradetauriupgradestrategygraystrategy fields.
var Columns = []string{
	FieldID,
	FieldEnable,
	FieldBeginDatetime,
...
// OrderOption defines the ordering options for the UpgradeTauriUpgradeStrategyGrayStrategy queries.
