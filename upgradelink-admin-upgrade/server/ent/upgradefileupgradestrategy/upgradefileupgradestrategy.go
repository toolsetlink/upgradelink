...
const (
	// Label holds the string label denoting the upgradefileupgradestrategy type in the database.
	Label = "upgrade_file_upgrade_strategy"
	...
	FieldFileID = "file_id"
	// FieldFileVersionID holds the string denoting the file_version_id field in the database.
	FieldFileVersionID = "file_version_id"
	...
	// Table holds the table name of the upgradefileupgradestrategy in the database.
	Table = "upgrade_file_upgrade_strategy"
)

// Columns holds all SQL columns for upgradefileupgradestrategy fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldEnable,
...
// OrderOption defines the ordering options for the UpgradeFileUpgradeStrategy queries.
...
// ByFileVersionID orders the results by the file_version_id field.
func ByFileVersionID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldFileVersionID, opts...).ToFunc()
}
