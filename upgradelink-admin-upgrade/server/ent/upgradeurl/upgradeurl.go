...
const (
	// Label holds the string label denoting the upgradeurl type in the database.
	Label = "upgrade_url"
	...
	// Table holds the table name of the upgradeurl in the database.
	Table = "upgrade_url"
)

// Columns holds all SQL columns for upgradeurl fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldKey,
...
// OrderOption defines the ordering options for the UpgradeUrl queries.
