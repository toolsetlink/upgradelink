...
const (
	// Label holds the string label denoting the upgradetauri type in the database.
	Label = "upgrade_tauri"
	...
	// Table holds the table name of the upgradetauri in the database.
	Table = "upgrade_tauri"
)

// Columns holds all SQL columns for upgradetauri fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldKey,
...
// OrderOption defines the ordering options for the UpgradeTauri queries.
