...
const (
	// Label holds the string label denoting the upgradeapkupgradestrategy type in the database.
	Label = "upgrade_apk_upgrade_strategy"
	...
	FieldApkID = "apk_id"
	// FieldApkVersionID holds the string denoting the apk_version_id field in the database.
	FieldApkVersionID = "apk_version_id"
	...
	// Table holds the table name of the upgradeapkupgradestrategy in the database.
	Table = "upgrade_apk_upgrade_strategy"
)

// Columns holds all SQL columns for upgradeapkupgradestrategy fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldEnable,
...
// OrderOption defines the ordering options for the UpgradeApkUpgradeStrategy queries.
...
// ByApkVersionID orders the results by the apk_version_id field.
func ByApkVersionID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldApkVersionID, opts...).ToFunc()
}
