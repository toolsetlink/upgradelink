...
const (
	// Label holds the string label denoting the upgradetauriupgradestrategy type in the database.
	Label = "upgrade_tauri_upgrade_strategy"
	...
	// FieldTauriVersionID holds the string denoting the tauri_version_id field in the database.
	FieldTauriVersionID = "tauri_version_id"
	...
	// Table holds the table name of the upgradetauriupgradestrategy in the database.
	Table = "upgrade_tauri_upgrade_strategy"
)

// Columns holds all SQL columns for upgradetauriupgradestrategy fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldEnable,
...
// OrderOption defines the ordering options for the UpgradeTauriUpgradeStrategy queries.
...
// ByTauriVersionID orders the results by the tauri_version_id field.
func ByTauriVersionID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldTauriVersionID, opts...).ToFunc()
}
